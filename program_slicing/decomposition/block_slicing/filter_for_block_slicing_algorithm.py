...
def does_slice_match_scope(scopes: Iterable[Statement], program_slice: ProgramSlice):
    """
    ...
    # print(f'{(program_slice.ranges[0][0].line_number, program_slice.ranges[-1][1].line_number)} in {scopes_lines}')
    return (program_slice.ranges[0][0].line_number, program_slice.ranges[-1][1].line_number) in scopes_lines
