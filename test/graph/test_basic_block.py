...
class BasicBlockTestCase(TestCase):
    ...
    def test_constructor(self):
        ...
        statement_a = Statement("a", STATEMENT_TYPE_OBJECT, (0, 0), (0, 1))
        statement_b = Statement("b", STATEMENT_TYPE_OBJECT, (1, 1), (1, 2))
    ...
    def test_is_empty(self):
        ...
        b = BasicBlock(statements=[Statement("a", STATEMENT_TYPE_OBJECT, (0, 0), (0, 1))])
    ...
    def test_append(self):
        ...
        statement_b = Statement("a", STATEMENT_TYPE_OBJECT, (0, 0), (0, 1))
